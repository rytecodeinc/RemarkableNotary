    ...
    <div className="grid gap-8">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-2 text-sm text-stone">Create and organize the curriculum.</p>
        </div>
      </div>
      ...
      <section className="grid gap-3">
        {courses.map((course) => (
          <Link key={course.id} href={`/admin/courses/${course.id}`} className="hover-lift card-panel block">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <span className={`text-xs uppercase tracking-[0.14em] ${course.is_published ? "text-emerald-700" : "text-stone"}`}>
