    ...
    <div className="bg-paper text-ink">
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="max-w-2xl">
          <p className="text-xs uppercase tracking-[0.22em] text-brass">The experience</p>
          ...
          <ul className="grid gap-3">
            {curriculum.map((item, index) => (
              ...
              >
                ...
                <span className="text-xs tracking-[0.18em] text-stone">{String(index + 1).padStart(2, "0")}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="hover-zoom relative overflow-hidden rounded-[2rem] border border-[var(--line-dark)] bg-white">
          <div className="zoom-target absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(196,163,90,0.18),transparent_42%),linear-gradient(135deg,#ffffff,#faf8f4_55%,#f3f1ec)]" />
